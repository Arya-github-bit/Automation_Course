...
public class JavaScriptExecutorforScroll extends Base {
	...
	public static void main(String[] args) {
		...
		JavaScriptExecutorforScroll javaScriptExecutorforScroll = new JavaScriptExecutorforScroll();
		javaScriptExecutorforScroll.initialiseBrowser();
		javaScriptExecutorforScroll.VerifySingleInputField();
